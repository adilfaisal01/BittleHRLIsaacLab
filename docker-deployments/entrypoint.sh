...
/IsaacLab/isaaclab.sh -p -m torch.distributed.run --nnodes=1 --nproc_per_node=2 /BittleHRL/scripts/rsl_rl/train.py \
  --task Template-Bittlehrl-Direct-v0 \
  --num_envs $NUM_ENVS \
  --max_iterations $MAX_ITERS \
  --video --headless --distributed --seed=-1 --video_interval=10000
